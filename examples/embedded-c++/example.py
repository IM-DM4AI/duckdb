...
con = duckdb.connect(
    "/home/duckdb/examples/embedded-c++/db_tpcx_ai_sf40.db")

model_file_name = "/home/duckdb/examples/embedded-c++/uc01.python.model"
...
con.create_function("udf", udf, [DOUBLE, DOUBLE],
                    BIGINT, type="arrow", null_handling=hand_type, kind=PythonUDFKind.BATCH_PREDICTION)
