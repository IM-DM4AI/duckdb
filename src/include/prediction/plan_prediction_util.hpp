...
enum class FunctionKind: u_int8_t {COMMON = 0, PREDICTION=1, PROCESS_PREDICTION=2, SCHEDULE_PREDICTION=3, THREAD_SCHEDULE_PREDICTION=4, THREAD_SCHEDULE_PREDICTION_WITH_BATCHING=5};
